...
# keep this line to run your programs 5 seconds after the system startup
sleep 5
...
#
# Also by default, all the startup programs listed here will be executed 5 seconds after the system startup.
